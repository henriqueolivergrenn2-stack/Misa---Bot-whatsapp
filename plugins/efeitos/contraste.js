...
export default {
    name: 'contraste',
    description: 'Ajusta o contraste da imagem (efeito "melhorar qualidade")',
    category: 'efeitos',
    aliases: ['contrast', 'melhora', 'melhorar', 'hd', 'to-hd'],
    async execute({ columbina, from, info, reply, reagir, getFileBuffer }) {
        ...
        try {
            ...
            await reagir('❌');
            reply(`❌ Erro ao aplicar contraste.\n\n(${err.message})`);
        } finally {
