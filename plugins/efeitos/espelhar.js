...
export default {
    name: 'espelhar',
    description: 'Inverte a imagem horizontalmente (espelho)',
    category: 'efeitos',
    aliases: ['muda-direcao', 'mudar-direcao', 'mirror'],
